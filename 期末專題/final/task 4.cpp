...
void game_begin() {
    ...
    al_draw_filled_rectangle(pos_x, pos_y, pos_x + 30, pos_y + 30, al_map_rgb(250,0,250));
    al_flip_display();
}
...
int process_event() {
    ...
    al_draw_filled_rectangle(pos_x,pos_y,pos_x+30,pos_y+30,al_map_rgb(250,0,0));
    /*
